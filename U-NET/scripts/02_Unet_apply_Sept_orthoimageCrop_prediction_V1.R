...
# Base workdir path
workdir <- "/mnt/gsdata/users/soltani/Workshop_home_fromSSD2/Workshop_home/2_Unet_on_flora_mask/2_MyDiv/"
ortho_image_file <- file.path(workdir, "data/UAV_Data/UAV_Orthoimags/Ortho_September/Ortho_Sept_2022_09_16_15_alt_ortho_mosaic.tif")
...
pred_folder <- file.path(outputfolder,"Ortho_Sept_" ,checkpoint_name,"/")
...
# Load customized loss function for Unet
